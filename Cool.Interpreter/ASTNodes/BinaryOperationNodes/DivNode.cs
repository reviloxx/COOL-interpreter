...
public class DivNode(ParserRuleContext? context, ExpressionNode leftOperand, ExpressionNode rightOperand) : BinaryOperationNode(context, leftOperand, rightOperand)
{
