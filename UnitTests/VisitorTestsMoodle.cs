...
public class VisitorTestsMoodle : VisitorTestsBase
{   
    [Test]
    [TestCase("arith.cl")]
    ...
    [TestCase("test.cl")]
    public void AlgorithmShouldSucceed(string testCase)
    {
        var file = FileHelper.GetFileMoodle(TestType.AlgorithmSuccess, testCase);
    ...
    public void AlgorithmShouldFail(string testCase)
    {
        var file = FileHelper.GetFileMoodle(TestType.AlgorithmFail, testCase);
        var context = GetProgramContext(file);
    ...
    public void ParsingShouldSucceed(string testCase)
    {
        var file = FileHelper.GetFileMoodle(TestType.ParsingSuccess, testCase);
        var context = GetProgramContext(file);
    ...
    public void ParsingShouldFail(string testCase)
    {
        var file = FileHelper.GetFileMoodle(TestType.ParsingFail, testCase);
        var context = GetProgramContext(file);
    ...
    [TestCase("whileOK.cl")]
    [TestCase("whileoneexpression.cl")]
    public void SemanticsShouldSucceed(string testCase)
    {
        var file = FileHelper.GetFileMoodle(TestType.SemanticsSuccess, testCase);
        var context = GetProgramContext(file);
    ...
    public void SemanticsShouldFail(string testCase)
    {
        var file = FileHelper.GetFileMoodle(TestType.SemanticsFail, testCase);
        var context = GetProgramContext(file);
