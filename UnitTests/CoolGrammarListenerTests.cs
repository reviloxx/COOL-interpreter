...
namespace CoolGrammarListenerTests;

public class AlgorithmTests : CoolGrammarListenerTestsBase
{
    [Test]
    [TestCase("arith.cl")]
...
public class ParsingTests : CoolGrammarListenerTestsBase
{
    [Test]
    [TestCase("abort.cl")]
...
public class SemanticsTests : CoolGrammarListenerTestsBase
{
    [Test]
    [TestCase("abort.cl")]
    [TestCase("addedlet.cl")]
